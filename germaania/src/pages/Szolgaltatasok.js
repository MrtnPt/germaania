...
const Prices = () => {
  return (
    <article>
      <h1 className="initiale">Szolgáltatások</h1>
      ...
      <div className="row">
        ...
        <div className="col-xl-4 col-lg-6">
          <div className="pricetag">
            ...
            <p>Csoportos órák kis létszámban (3-6 fővel) valósulnak meg <span className="bold">heti 2 alkalommal 90 percben</span>.</p>
            <h4>Kedvezmény:</h4>
            <ul>
              <li><IoPricetagOutline  />
