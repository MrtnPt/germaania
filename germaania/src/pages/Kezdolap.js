    ...
    <>
      <article className={isMobile ? "row" : ""}>
        ...
        <ul id='checklist' className={isMobile ? "col-12" : ""}>
          ...
          <li><IconContext.Provider value={{ className: "react-icons" }}><IoCheckboxOutline  /></IconContext.Provider> német nyelvterületre költözöl és segítségre van szükséged, hogy ki tudd fejezni magad és megértsd ha hozzád szólnak,</li>
