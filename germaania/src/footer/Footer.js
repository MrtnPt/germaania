    ...
    return (
        <div id="footer-container" className="space-around">
            ...
            <div id="right" className="col-xl-4">
                ...
                <p>Borító képek <a target="_blank" rel="noreferrer" href="https://www.pexels.com/photo/cup-of-coffee-on-saucer-414630/">Pixabay</a>, <a target="_blank" rel="norefferer" href="https://www.pexels.com/photo/silver-laptop-and-white-cup-on-table-7974/">Life Of Pix</a> és <a target="_blank" rel="noreferrer" href="https://www.pexels.com/photo/open-notebook-near-the-laptop-9969255/">Vlada Karpovich</a> jóvoltából</p>
            </div>
        </div>
    )
};
